...
URL = f"https://gateway-arbitrum.network.thegraph.com/api/{API_KEY}/subgraphs/id/5NkRZE6kKHsh2GdwPo52whV9HePWBzfwMndbwPFJtTBz"
...
async def main():
    ...
    async with aiohttp.ClientSession() as session:
        while True:
            ...
            with open('transfer_results_arbi.json', 'w') as f:
